...
class RouteSuggestion {
    ...
    @Enumerated(EnumType.STRING) @Column(nullable=false,length=16) private SuggestionStatus status;
    ...
    RouteSuggestion(String publicId,Route route,SuggestionType type,String authorName,String description,String category,String tags,
        ...
        this.publicId=publicId;this.route=route;this.type=type;this.status=SuggestionStatus.PENDING;this.authorName=authorName;
    ...
    String getPublicId(){return publicId;} SuggestionType getType(){return type;} SuggestionStatus getStatus(){return status;}
