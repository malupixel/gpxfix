...
class RouteMapper {
    RouteDto toDto(Route route) {
        ...
        return new RouteDto(route.getPublicId(),route.getName(),route.getDescription(),route.getDistanceMeters(),route.getElevationGainMeters(),new RouteDto.GeoJsonLineString("LineString",coordinates),route.getCreatedAt());
    }
